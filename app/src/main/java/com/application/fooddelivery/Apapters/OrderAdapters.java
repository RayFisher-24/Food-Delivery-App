package com.application.fooddelivery.Apapters;
...
import com.application.fooddelivery.DBhalper;
import com.application.fooddelivery.DetailActivity;
                ...
                new AlertDialog.Builder(context)
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                DBhalper dBhalper=new DBhalper(context);
